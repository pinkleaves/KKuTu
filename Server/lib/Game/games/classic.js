...
exports.submit = function(client, text){
	...
	if(text.indexOf(" ")!=-1 && !my.opts.spacewd) return client.publish('turnError', { code: 404, value: text }, true);
	if(text.match(/[^A-Za-z\s]/) && !my.opts.specwd && my.rule.lang == 'en') return client.publish('turnError', { code: 404, value: text }, true);
