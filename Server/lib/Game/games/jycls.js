...
exports.submit = function(client, text){
	...
	try{
		...
		if(my.opts.rrlanner && text.charAt(text.length - 1).match(/[^가-힣ㄱ-ㅎㅏ-ㅣ0-9A-Za-z]/g)) return client.publish('turnError', { code: 456, value: text }, true);
	}catch(e){
		var asdasf = 1234;
	}
...
function getSubChar(char){
	...
	switch(Const.GAME_TYPE[my.mode]){
		...
		case "KKT": case "KJH": case "KAP":
			...
			break;
		case "EJH": case "EKD": case "EAP": default:
			break;
	}
	return r;
}